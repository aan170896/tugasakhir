...
<head>
  <title>TL &mdash; TerminalLaser</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

  <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/https://fonts.googleapis.com/css?family=Nunito+Sans:200,300,400,700,900">
    ...
    <div class="site-navbar-wrap">
        ...
        <div class="container py-3">
          <div class="row align-items-center">
            <div class="col-6">
              ...
              <a href="https://facebook.com/sarkek.kek/" class="p-2 pl-0"><span class="icon-facebook"></span></a>
              <a href="https://instagram.com/akrilik_spesialis/" class="p-2 pl-0"><span class="icon-instagram"></span></a>
            </div>
            <div class="col-6">
              <div class="d-flex ml-auto">
                <a href="https://mail.google.com/mail" class="d-flex align-items-center ml-auto mr-4">
                  <span class="icon-envelope mr-2"></span>
                  <span class="d-none d-md-inline-block">terminal.laser@gmail.com</span>
                </a>
                <a href="#" class="d-flex align-items-center">
                  <span class="icon-phone mr-2"></span>
                  <span class="d-none d-md-inline-block">0822 2130 0111</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <div class="site-navbar site-navbar-target js-sticky-header">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-5.5">
              <h1 class=" site-logo"><a href="#home-section">Terminal Laser</a></h1>
            </div>
            <div class="col-7">
              <nav class="site-navigation text-right" role="navigation">
                <div class="container">
                  ...
                  <ul class="site-menu main-menu js-clone-nav d-none d-lg-block">
                    ...
                    <li><a href="#product-section" class="nav-link">Our Product</a></li>
                    <li><a href="#orders-section" class="nav-link">Order</a></li>
                    <!-- <li><a href="#services-section" class="nav-link">Order</a></li> -->
      ...
      <div class="container">
        <div class="row align-items-center text-center justify-content-center">
          <div class="col-md-8">
            ...
            <span class="sub-text mb-3 d-block"><em>We Are Industrial, Commercial, Creative</em></span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person">
              <div class="bio-img">
                <figure>
                  <img src="<?php echo base_url(); ?>/assets/images/person_1.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="social">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person">
              <div class="bio-img">
                <figure>
                  <img src="<?php echo base_url(); ?>/assets/images/person_3.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="social">
                  <a href="#"><span class="icon-facebook"></span></a>
                  <a href="#"><span class="icon-twitter"></span></a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person">
              <div class="bio-img">
                <figure>
                  <img src="<?php echo base_url(); ?>/assets/images/person_4.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="social">
                  <a href="#"><span class="icon-facebook"></span></a>
                  <a href="#"><span class="icon-twitter"></span></a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person">
              <div class="bio-img">
                <figure>
                  <img src="<?php echo base_url(); ?>/assets/images/person_5.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="social">
                                             <a href="#"><span class="icon-facebook"></span></a>
                  <a href="#"><span class="icon-twitter"></span></a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person">
              <div class="bio-img">
                <figure>
                  <img src="<?php echo base_url(); ?>/assets/images/person_6.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="social">
                  <a href="#"><span class="icon-facebook"></span></a>
                  <a href="#"><span class="icon-twitter"></span></a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <img src="<?php echo base_url(); ?>/assets/images/about_2.jpg" alt="Image" class="img-fluid">
          </div>
